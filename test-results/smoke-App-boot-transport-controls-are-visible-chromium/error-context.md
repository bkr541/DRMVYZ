...
- Name: smoke.spec.ts >> App boot >> transport controls are visible
- Location: src/test/e2e/smoke.spec.ts:33:3
...
Locator: locator('[title="Play"]').or(locator('[title="Pause"]'))
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[title="Play"]').or(locator('[title="Pause"]'))
