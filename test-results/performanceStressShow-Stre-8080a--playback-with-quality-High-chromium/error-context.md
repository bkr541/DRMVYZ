...
- Name: performanceStressShow.spec.ts >> Stress-show stability >> app is stable after 5 s playback with quality High
- Location: src/test/e2e/performanceStressShow.spec.ts:35:3
...
Locator: locator('.vz-preview-pill--fps')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.vz-preview-pill--fps')
