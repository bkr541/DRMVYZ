...
- Name: performanceStressShow.spec.ts >> Stress-show stability >> output health indicator is visible and not in error state at idle
- Location: src/test/e2e/performanceStressShow.spec.ts:78:3
...
Locator: locator('.vz-preview-transport')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.vz-preview-transport')
