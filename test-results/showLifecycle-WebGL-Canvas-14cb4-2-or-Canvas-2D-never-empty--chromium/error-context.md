...
- Name: showLifecycle.spec.ts >> WebGL / Canvas fallback >> renderer type pill shows WebGL2 or Canvas 2D (never empty)
- Location: src/test/e2e/showLifecycle.spec.ts:80:3
...
Locator:  locator('.vz-preview-pill')
Expected: 3
Received: 0
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('.vz-preview-pill')
