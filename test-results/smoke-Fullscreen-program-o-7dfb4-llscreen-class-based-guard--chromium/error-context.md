...
- Name: smoke.spec.ts >> Fullscreen program output >> diagnostic overlays are absent during fullscreen (class-based guard)
- Location: src/test/e2e/smoke.spec.ts:43:3
