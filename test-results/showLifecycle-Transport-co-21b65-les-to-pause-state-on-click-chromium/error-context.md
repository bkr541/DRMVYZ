...
- Name: showLifecycle.spec.ts >> Transport controls >> play button toggles to pause state on click
- Location: src/test/e2e/showLifecycle.spec.ts:34:3
...
Call log:
  ...
  - waiting for locator('[title="Play"]')
