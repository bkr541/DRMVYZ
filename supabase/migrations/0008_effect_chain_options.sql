...
values
  ...
  ('reactiveGrid',    'Reactive Grid',      'reactiveGrid',    'Draws a perspective emissive grid whose movement and warping respond to low-frequency audio energy.',                                                  'generative',    'Audio Reactive',          16, true),
