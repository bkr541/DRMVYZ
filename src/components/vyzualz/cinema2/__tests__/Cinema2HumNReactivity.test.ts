...
import { HUM_BPM, humMusicFrame, type HumFrameInput } from './support/Cinema2HumNFrameFactory'
...
function createHarness(options: { seed?: string; state?: Record<string, number> } = {}): Harness {
...
describe('HUM:N reactive manifest contract', () => {
  it('is manifest revision 14 and compiles with only render.webgl2 available', () => {
    expect(CINEMA2_HUMN_PRESET_MANIFEST.revision).toBe(14)
