...
function executionContext() {
  return {
    ...
    input: { id: 'effect-color-input', attachment: 'color' as const, texture: {} as WebGLTexture, width: 640, height: 360 },
    inputs: [{ id: 'effect-color-input', attachment: 'color' as const, texture: {} as WebGLTexture, width: 640, height: 360 }],
    target: null,
    width: 640,
    height: 360,
  } as const
