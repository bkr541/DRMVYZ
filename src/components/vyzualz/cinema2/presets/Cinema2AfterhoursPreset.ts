...
export const CINEMA2_AFTERHOURS_PRESET_MANIFEST: Readonly<Cinema2NativePresetManifest> = Object.freeze({
  ...
  parameters: Object.freeze([
    Object.freeze({
      ...
      section: 'Design', group: 'Color', designParentGroup: 'palette' as const, order: 10,
    ...
    Object.freeze({
      ...
      section: 'Design', group: 'Color', designParentGroup: 'palette' as const, order: 11,
      exposure: 'primary' as const, persistence: 'preset' as const, reset: 'authored-default' as const,
    }),
    Object.freeze({
      id: CINEMA2_AFTERHOURS_PRIMARY_COLOR_ID,
      label: 'Primary Color', type: 'color' as const, defaultValue: PRIMARY_COLOR,
      section: 'Design', group: 'Color', designParentGroup: 'palette' as const, order: 12,
      exposure: 'primary' as const, persistence: 'preset' as const, reset: 'authored-default' as const,
    ...
    Object.freeze({
      ...
      section: 'Design', group: 'Color', designParentGroup: 'palette' as const, order: 13,
      exposure: 'primary' as const, persistence: 'preset' as const, reset: 'authored-default' as const,
      visibleWhen: Object.freeze([Object.freeze({ kind: 'parameter-equals' as const, parameterId: CINEMA2_AFTERHOURS_COLOR_MODE_ID, value: 'manual' })]),
    }),
    Object.freeze({
      ...
      section: 'Design', group: 'Color', designParentGroup: 'palette' as const, order: 14,
      exposure: 'primary' as const, persistence: 'preset' as const, reset: 'authored-default' as const,
    }),
    Object.freeze({
    ...
    Object.freeze({
      ...
      section: 'Design', group: 'Rig', designParentGroup: 'design' as const, order: 23,
      exposure: 'primary' as const, persistence: 'preset' as const, reset: 'authored-default' as const,
    }),
    Object.freeze({
      ...
      section: 'Design', group: 'Pattern', designParentGroup: 'design' as const, order: 30,
      exposure: 'primary' as const, persistence: 'preset' as const, reset: 'authored-default' as const,
    }),
    Object.freeze({
    ...
    Object.freeze({
      ...
      section: 'Design', group: 'Motion', designParentGroup: 'design' as const, order: 40,
      exposure: 'primary' as const, persistence: 'preset' as const, reset: 'authored-default' as const,
    }),
    Object.freeze({
    ...
    Object.freeze({
      ...
      section: 'Design', group: 'Atmosphere', designParentGroup: 'effects' as const, order: 50,
      exposure: 'primary' as const, persistence: 'preset' as const, reset: 'authored-default' as const,
    }),
    Object.freeze({
      ...
      section: 'Design', group: 'Atmosphere', designParentGroup: 'master-controls' as const, order: 51,
      exposure: 'primary' as const, persistence: 'preset' as const, reset: 'authored-default' as const,
    }),
    Object.freeze({
    ...
    Object.freeze({
      ...
      section: 'Design', group: 'Reactivity', designParentGroup: 'effects' as const, order: 102,
      exposure: 'primary' as const, persistence: 'preset' as const, reset: 'authored-default' as const,
    }),
    Object.freeze({
      id: CINEMA2_AFTERHOURS_PULSE_DECAY_ID,
      label: 'Pulse Decay', type: 'float' as const, defaultValue: 0.45, min: 0, max: 1, step: 0.01,
      section: 'Design', group: 'Reactivity', designParentGroup: 'effects' as const, order: 103,
      exposure: 'primary' as const, persistence: 'preset' as const, reset: 'authored-default' as const,
    }),
    Object.freeze({
      ...
      section: 'Design', group: 'Structure', designParentGroup: 'effects' as const, order: 110,
      exposure: 'primary' as const, persistence: 'preset' as const, reset: 'authored-default' as const,
    }),
    Object.freeze({
      ...
      section: 'Effects', group: 'Feedback', designParentGroup: 'effects' as const, order: 900,
