...
export type CinemaDiagnosticCode =
  ...
  | 'CINEMA_MODULATION_SOURCE_UNAVAILABLE'
  | 'CINEMA_MODULATION_ROUTE_INVALID'
  | 'CINEMA_MODULATION_ROUTE_INCOMPATIBLE'
  | 'CINEMA_PERFORMANCE_RULE_INVALID'
  | 'CINEMA_PERFORMANCE_DURATION_UNAVAILABLE'
  | 'CINEMA_ASSET_BINDING_MISSING'
  | 'CINEMA_QUALITY_DECLARATION_INVALID'
  | 'CINEMA_COMPOSITION_EXPENSIVE'
  | 'CINEMA_QUALITY_DEGRADED'
  | 'CINEMA_GPU_TIMER_UNAVAILABLE'
  | 'CINEMA_GPU_TIMER_DISJOINT'
  | 'CINEMA_NODE_SKIPPED'
  | 'CINEMA_NODE_FROZEN'
  | 'CINEMA_VALIDATION_FAILED'
  | 'CINEMA_COMPILE_FAILED'
  | 'CINEMA_CAPABILITY_UNAVAILABLE'
  | 'CINEMA_CAMERA_INVALID'
  | 'CINEMA_CAMERA_CAPABILITY_MISMATCH'
  | 'CINEMA_CAMERA_SAFE_RANGE_CORRECTED'
  | 'CINEMA_CAMERA_SHOT_UNAVAILABLE'
  | 'CINEMA_PLUGIN_UNAVAILABLE'
  | 'CINEMA_ASSET_MISSING'
  | 'CINEMA_ASSET_BINDING_INVALID'
  | 'CINEMA_ASSET_CAPABILITY_MISMATCH'
  | 'CINEMA_ASSET_RECURSIVE_BINDING'
  | 'CINEMA_ASSET_RUNTIME_RELEASED'
  | 'CINEMA_BRAND_ROLE_UNAVAILABLE'
  | 'CINEMA_BRAND_POLICY_INVALID'
  ...
  | 'CINEMA_MEDIA_PLAYBACK_BLOCKED'
  | 'CINEMA_MEDIA_SYNC_FAILED'
  | 'CINEMA_FONT_UNAVAILABLE'
  | 'CINEMA_CONTEXT_LOST'
  | 'CINEMA_CONTEXT_RESTORED'
  | 'CINEMA_CONTEXT_RECOVERY_FAILED'
