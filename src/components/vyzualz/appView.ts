export const APP_VIEWS = ['react', 'visualizer', 'lyrics', 'media'] as const

export type AppView = (typeof APP_VIEWS)[number]
export type PerformanceAppView = Extract<AppView, 'react' | 'visualizer'>
...
export function isPerformanceAppView(view: AppView): view is PerformanceAppView {
  return view === 'react' || view === 'visualizer'
}
