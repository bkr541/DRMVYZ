...
export function VisualizerWorkspace({
  ...
  // Captured once at mount: VisualizerWorkspace fully unmounts/remounts on every
  // navigation, so the prop must be read as a one-shot "just arrived from a lyric
  // preview" signal rather than compared against this component's own history.
  ...
  }, [shouldShowLyricPreviewToast, showSourceToast])
