...
function laserDmxScannerRendererDiagnostics(frame: LaserDmxSceneFrame) {
  ...
  return {
    ...
    rawExposureSampleCount: diagnostics.rawExposureSampleCount,
    aggregatedRayCount: diagnostics.aggregatedRayCount,
    scannerEnergyBeforeAggregation: diagnostics.energyBeforeAggregation,
    scannerEnergyAfterAggregation: diagnostics.energyAfterAggregation,
    macroControlledPathCount: diagnostics.macroControlledPathCount,
    duplicateRenderingFixtureIds: [...diagnostics.duplicateRenderingFixtureIds],
    ...
    if (webglRuntime?.repeatedContextLoss) {
      ...
      if (result.ok && result.diagnostics) {
        ...
        publishLaserDmxRendererDiagnostics({
          ...
          laserHistoryInputCount: diagnostics.laserHistoryInputCount,
          laserHistorySliceCount: diagnostics.laserHistorySliceCount,
