...
>> = Object.freeze({
  'prism-cathedral': Object.freeze({
    ...
    status: 'available',
    program: authorLaserDmxBuiltInPerformanceProgram('prism-cathedral', createPrismCathedralProgram()),
  }),
  'cardinal-fan-reactor': Object.freeze({
    id: 'cardinal-fan-reactor',
    name: 'Cardinal Fan Reactor',
    status: 'available',
    program: authorLaserDmxBuiltInPerformanceProgram('cardinal-fan-reactor', createCardinalFanReactorProgram()),
  }),
  'cyan-mirror-cage': Object.freeze({
    id: 'cyan-mirror-cage',
    name: 'Cyan Mirror Cage',
    status: 'available',
    program: authorLaserDmxBuiltInPerformanceProgram('cyan-mirror-cage', createCyanMirrorCageProgram()),
  }),
  'small-club-rig-performance': Object.freeze({ id: 'small-club-rig-performance', name: 'Small Club Performance', status: 'available', program: authorLaserDmxBuiltInPerformanceProgram('small-club-rig-performance', createSmallClubPerformanceProgram()) }),
  'festival-front-beams-performance': Object.freeze({ id: 'festival-front-beams-performance', name: 'Festival Front Beams Performance', status: 'available', program: authorLaserDmxBuiltInPerformanceProgram('festival-front-beams-performance', createFestivalFrontBeamsPerformanceProgram()) }),
  'dubstep-drop-lasers-performance': Object.freeze({ id: 'dubstep-drop-lasers-performance', name: 'Dubstep Drop Lasers Performance', status: 'available', program: authorLaserDmxBuiltInPerformanceProgram('dubstep-drop-lasers-performance', createDubstepDropLasersPerformanceProgram()) }),
  'led-bar-grid-performance': Object.freeze({ id: 'led-bar-grid-performance', name: 'LED Bar Grid Performance', status: 'available', program: authorLaserDmxBuiltInPerformanceProgram('led-bar-grid-performance', createLedBarGridPerformanceProgram()) }),
  'moving-head-sweep-performance': Object.freeze({ id: 'moving-head-sweep-performance', name: 'Moving Head Sweep Performance', status: 'available', program: authorLaserDmxBuiltInPerformanceProgram('moving-head-sweep-performance', createMovingHeadSweepPerformanceProgram()) }),
  'strobe-blinder-hits-performance': Object.freeze({ id: 'strobe-blinder-hits-performance', name: 'Strobe + Blinder Performance', status: 'available', program: authorLaserDmxBuiltInPerformanceProgram('strobe-blinder-hits-performance', createStrobeBlinderPerformanceProgram()) }),
  'haze-co2-drops-performance': Object.freeze({ id: 'haze-co2-drops-performance', name: 'Haze + CO2 Performance', status: 'available', program: authorLaserDmxBuiltInPerformanceProgram('haze-co2-drops-performance', createHazeCo2PerformanceProgram()) }),
  'vocal-eclipse-exchange': Object.freeze({ id: 'vocal-eclipse-exchange', name: 'Vocal Eclipse Exchange', status: 'available', program: authorLaserDmxBuiltInPerformanceProgram('vocal-eclipse-exchange', createVocalEclipseExchangeProgram()) }),
  'emerald-tunnel-relay': Object.freeze({ id: 'emerald-tunnel-relay', name: 'Emerald Tunnel Relay', status: 'available', program: authorLaserDmxBuiltInPerformanceProgram('emerald-tunnel-relay', createEmeraldTunnelRelayProgram()) }),
  'white-vector-interlock': Object.freeze({ id: 'white-vector-interlock', name: 'White Vector Interlock', status: 'available', program: authorLaserDmxBuiltInPerformanceProgram('white-vector-interlock', createWhiteVectorInterlockProgram()) }),
  'aurora-canopy-drift': Object.freeze({ id: 'aurora-canopy-drift', name: 'Aurora Canopy Drift', status: 'available', program: authorLaserDmxBuiltInPerformanceProgram('aurora-canopy-drift', createAuroraCanopyDriftProgram()) }),
  'chromatic-chapter-stage': Object.freeze({ id: 'chromatic-chapter-stage', name: 'Chromatic Chapter Stage', status: 'available', program: authorLaserDmxBuiltInPerformanceProgram('chromatic-chapter-stage', createChromaticChapterStageProgram()) }),
  'prismatic-pulse-matrix': Object.freeze({ id: 'prismatic-pulse-matrix', name: 'Prismatic Pulse Matrix', status: 'available', program: authorLaserDmxBuiltInPerformanceProgram('prismatic-pulse-matrix', createPrismaticPulseMatrixProgram()) }),
  'spectral-ribbon-singularity': Object.freeze({ id: 'spectral-ribbon-singularity', name: 'Spectral Ribbon Singularity', status: 'available', program: authorLaserDmxBuiltInPerformanceProgram('spectral-ribbon-singularity', createSpectralRibbonSingularityProgram()) }),
  'crimson-apex-protocol': Object.freeze({ id: 'crimson-apex-protocol', name: 'Crimson Apex Protocol', status: 'available', program: authorLaserDmxBuiltInPerformanceProgram('crimson-apex-protocol', createCrimsonApexProtocolProgram()) }),
  'violet-hourglass-orbit': Object.freeze({ id: 'violet-hourglass-orbit', name: 'Violet Hourglass Orbit', status: 'available', program: authorLaserDmxBuiltInPerformanceProgram('violet-hourglass-orbit', createVioletHourglassOrbitProgram()) }),
  'scarlet-origami-lattice': Object.freeze({ id: 'scarlet-origami-lattice', name: 'Scarlet Origami Lattice', status: 'available', program: authorLaserDmxBuiltInPerformanceProgram('scarlet-origami-lattice', createScarletOrigamiLatticeProgram()) }),
})
