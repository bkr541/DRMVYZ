...
/* ───────────────────────────────────────────────────────────────────────────
   "Card" family — one card per media layer: the Active Media dropdown is the
   card's own header, and that media's effects and their Audio Intelligence
   routes live inside the same card. The variants differ only in how the card
   is dressed. No free-floating connector lines — only full-width dividers and
   container edges. Kept: Ledger Card, Thumb Card, Thumb Card B.
   ─────────────────────────────────────────────────────────────────────────── */
...
/* ───────────────────────────────────────────────────────────────────────────
   Colored Effect Spine — routing stays physically attached to its effect;
   every effect carries its own accent color and its own short left-border
   spine, with row-centred ticks.
   ─────────────────────────────────────────────────────────────────────────── */
