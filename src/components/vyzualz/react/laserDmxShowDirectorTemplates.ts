...
export const LASER_DMX_SHOW_DIRECTOR_TEMPLATES = [
  {
    ...
    settings: grid(15, 10),
    fixtures: [
      fx('ledBar', 'Front LED Bar L', 4, 8, { rotation: 0, color: LASER_CYAN, trigger: { mode: 'beat', beatDivision: 1, fadeOutMs: 180 }, component: { ledCellCount: 12, ledDirection: 'leftToRight' } }),
      fx('ledBar', 'Front LED Bar R', 10, 8, { rotation: 0, color: LASER_GREEN, trigger: { mode: 'beat', beatDivision: 2, fadeOutMs: 220 }, component: { ledCellCount: 12, ledDirection: 'rightToLeft' } }),
      ...
      fx('haze', 'Soft Haze', 1, 1, { color: CO2_BLUE, brightness: 0.36, trigger: { mode: 'section', sectionTypes: ['intro', 'verse', 'build', 'drop', 'breakdown'], fadeInMs: 900, fadeOutMs: 1100 }, component: { hazeIntensity: 0.38 } }),
    ],
  },
  {
    ...
    fixtures: [
      ...
      fx('parWash', 'Festival Wash L', 0, 4, { color: '#225cff', beam: { beamSpread: 88, focus: 0.28 }, trigger: { mode: 'section', sectionTypes: ['build', 'drop'], fadeInMs: 500, fadeOutMs: 720 } }),
      fx('parWash', 'Festival Wash R', 17, 4, { color: '#00d9a3', beam: { beamSpread: 88, focus: 0.28 }, trigger: { mode: 'section', sectionTypes: ['build', 'drop'], fadeInMs: 500, fadeOutMs: 720 } }),
    ],
  },
  {
  ...
  },
  {
    ...
    settings: grid(15, 10),
    fixtures: [
      fx('ledBar', 'Top Bar 1', 3, 2, { color: LASER_CYAN, trigger: { mode: 'beat', beatDivision: 0.5, fadeOutMs: 150 }, component: { ledCellCount: 10, ledDirection: 'leftToRight' } }),
      fx('ledBar', 'Top Bar 2', 7, 2, { color: LASER_BLUE, trigger: { mode: 'beat', beatDivision: 2, fadeOutMs: 220 }, component: { ledCellCount: 10, ledDirection: 'centerOut' } }),
      fx('ledBar', 'Top Bar 3', 11, 2, { color: LASER_GREEN, trigger: { mode: 'beat', beatDivision: 1, fadeOutMs: 180 }, component: { ledCellCount: 10, ledDirection: 'rightToLeft' } }),
      fx('ledBar', 'Mid Bar 1', 3, 5, { color: '#ff4ed8', trigger: { mode: 'beat', beatDivision: 0.5, fadeOutMs: 140 }, component: { ledCellCount: 12, ledDirection: 'chase' } }),
      ...
      fx('ledBar', 'Mid Bar 3', 11, 5, { color: '#61d6aa', trigger: { mode: 'beat', beatDivision: 0.5, fadeOutMs: 140 }, component: { ledCellCount: 12, ledDirection: 'chase' } }),
  ...
  },
  {
    ...
    fixtures: [
      ...
      fx('movingHead', 'Sweep Head BL', 4, 3, { color: LASER_BLUE, rotation: 32, beam: { targetMode: 'mirror', beamSpread: 10, targetX: 10, targetY: 7 }, trigger: { mode: 'bar', barInterval: 1, fadeOutMs: 200 }, component: { movingHeadPanTiltStyle: 'smoothSweep' } }),
      fx('movingHead', 'Sweep Head BR', 10, 3, { color: LASER_MAGENTA, rotation: 148, beam: { targetMode: 'mirror', beamSpread: 10, targetX: 4, targetY: 7 }, trigger: { mode: 'bar', barInterval: 1, fadeOutMs: 200 }, component: { movingHeadPanTiltStyle: 'smoothSweep' } }),
  ...
  },
  {
    ...
    settings: grid(15, 10),
    fixtures: [
      fx('haze', 'Haze Base L', 1, 2, { color: '#9ddfff', brightness: 0.42, trigger: { mode: 'section', sectionTypes: ['intro', 'verse', 'build', 'drop', 'breakdown'], fadeInMs: 1200, fadeOutMs: 1600 }, component: { hazeIntensity: 0.44 } }),
      fx('haze', 'Haze Base R', 13, 2, { color: '#a7ffe9', brightness: 0.42, trigger: { mode: 'section', sectionTypes: ['intro', 'verse', 'build', 'drop', 'breakdown'], fadeInMs: 1200, fadeOutMs: 1600 }, component: { hazeIntensity: 0.44 } }),
