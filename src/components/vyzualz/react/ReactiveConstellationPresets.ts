...
export const REACTIVE_CONSTELLATION_CURATED_PRESETS: readonly ReactPreset[] = [
  {
    ...
    description: 'The closest match to the reference recording: a crimson-magenta crystal network that caves inward, snaps open, and leaves layered laser-fan ghosts behind it.',
    engine: 'cinematicPortal',
    palette: { primary: '#ff174f', secondary: '#c20cff', accent: '#ff5b87', background: '#050006', highlight: '#fff0f5', text: '#ffffff' },
    params: { intensity: 0.96, motion: 0.82, glow: 0.98, bassReactivity: 0.94 },
    renderSettings: { trailDecay: 0.045, fogDensity: 0.2, particleDensity: 0.34 },
    cinematicConfig: createCinematicWorldConfig('reactiveConstellation', {
      visualDnaProfile: 'heavyDubstep', macroStructure: 0.76, macroMotion: 0.78, macroImpact: 0.94, macroTrails: 0.9, macroMaterial: 0.92, macroCamera: 0.82,
      nodeCount: 58, topologyStyle: 'splitClusters', polyhedronStyle: 'mixed', networkSpread: 1.42, depthSpread: 1.18, neighborCount: 5,
      nodeScale: 0.15, nodeScaleVariation: 0.62, faceOpacity: 0.9, facetContrast: 1.72, internalGlow: 1.22, rimIntensity: 1.52, wireframeAmount: 0.5, colorVariation: 0.72, nodeSpin: 0.62,
      backgroundCurtains: 0.72, curtainDensity: 18, depthFade: 0.48, beamWidth: 3.2, beamCoreBrightness: 4.2, beamGlow: 1.72, edgeOpacity: 0.94,
      trailSamples: 24, trailDecay: 0.86, trailSpacing: 0.024, beamFanAmount: 1.62,
      centralGravity: 0.34, cameraOrbit: 0.24, springStrength: 1.18, damping: 0.46, driftAmount: 0.16, turbulence: 0.38, orbitAmount: 0.18, elasticity: 0.86, topologyStability: 0.62, collapseAmount: 0.42, burstStrength: 1.42, reseedEveryBars: 16,
    }, {
      seed: 49001, qualityTier: 'high', cameraRig: 'autoDirector',
      camera: { autoDirector: { strength: 0.94, cameraActivity: 0.82, transitionFrequency: 0.82, dropImpact: 1, buildIntensity: 0.9, minimumShotDurationSec: 2.8, transitionDurationSec: 0.58, preferMusicalBoundaries: true, repeatAvoidance: 3, manualOverrideRig: null, lockUntilNextSection: false, manualCameraLock: false } },
      environment: { depth: 0.94, architecture: 0.12, fog: 0.18, debris: 0.08, stars: 0.18, atmosphere: 0.58 },
      material: { distortion: 0.05, refraction: 0.04, bloom: 0.96, chromaticAberration: 0.055, feedback: 0, glow: 1 },
      audioMapping: { enabled: true, smoothingMs: 34, routes: [
        route('crimson-sub-collapse', 'subBass', 'collapseForce', { amount: 0.86, attackMs: 30, releaseMs: 280, threshold: 0.05, responseCurve: 'easeOut' }),
        route('crimson-kick-burst', 'kick', 'burstImpulse', { amount: 1.28, attackMs: 0, releaseMs: 210, beatHoldMs: 18, decayMs: 260, sectionScale: { drop: 1.35, build: 0.72 } }),
        route('crimson-snare-beams', 'snare', 'edgeBrightness', { amount: 0.9, attackMs: 0, releaseMs: 150, beatHoldMs: 12, decayMs: 190 }),
        route('crimson-build-fans', 'buildProgress', 'trailLength', { amount: 0.96, attackMs: 160, releaseMs: 520, responseCurve: 'smoothstep' }),
        route('crimson-drop-fold', 'dropEntry', 'topologyMorph', { amount: 1.02, attackMs: 0, releaseMs: 560, beatHoldMs: 70, decayMs: 620 }),
        route('crimson-drop-camera', 'dropEntry', 'cameraPunch', { amount: 1.12, attackMs: 0, releaseMs: 300, beatHoldMs: 45, decayMs: 350 }),
      ] },
    }),
