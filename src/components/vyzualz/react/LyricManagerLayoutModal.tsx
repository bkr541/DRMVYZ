...
const POPUP_NAME = 'drmvyz-lyric-manager-layout'
...
export function LyricManagerLayoutModal({ onClose }: { onClose: () => void }) {
  ...
  useEffect(() => {
    ...
    popup.document.title = 'DRMVYZ — Lyric Manager Layout'
  ...
  return createPortal(<LyricManagerLayoutMockup />, container)
}
