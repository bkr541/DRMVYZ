...
const CANVAS_ACTIONS: readonly ReactPerformanceActionDefinition[] = [
  ...
  { id: 'canvas.bassBloom', padId: 'pad-2', keyBinding: '2', label: 'Bloom', description: 'Trigger the CANVAS bloom performance recipe for a source-forward bass swell.', color: '#61d6aa', behavior: 'oneShot', target: CANVAS_TARGET, canvasAction: 'selectPreset', canvasPresetId: 'canvas-bass-bloom' },
  { id: 'canvas.ghostEcho', padId: 'pad-3', keyBinding: '3', label: 'Ghost', description: 'Trigger the CANVAS echo performance recipe for trails and transparent motion.', color: '#9ddcff', behavior: 'oneShot', target: CANVAS_TARGET, canvasAction: 'selectPreset', canvasPresetId: 'canvas-ghost-echo' },
  { id: 'canvas.glitchPulse', padId: 'pad-4', keyBinding: '4', label: 'Glitch', description: 'Trigger the CANVAS glitch performance recipe for RGB splits and hard rhythmic energy.', color: '#ff6b9d', behavior: 'oneShot', target: CANVAS_TARGET, canvasAction: 'selectPreset', canvasPresetId: 'canvas-glitch-pulse' },
  { id: 'canvas.lumaMelt', padId: 'pad-17', keyBinding: '5', label: 'Luma', description: 'Trigger the CANVAS luma performance recipe for bright threshold smears.', color: '#d8b95a', behavior: 'oneShot', target: CANVAS_TARGET, canvasAction: 'selectPreset', canvasPresetId: 'canvas-luma-melt' },
  { id: 'canvas.frameStutter', padId: 'pad-5', keyBinding: 'q', label: 'Stutter', description: 'Trigger the CANVAS stutter performance recipe for clipped rhythmic video motion.', color: '#b84fc9', behavior: 'oneShot', target: CANVAS_TARGET, canvasAction: 'selectPreset', canvasPresetId: 'canvas-frame-stutter' },
