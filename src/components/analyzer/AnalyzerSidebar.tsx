...
export function AnalyzerSidebar({
  ...
  // Only show the two-icon switcher when in the vyzualz context
  const showAppViewSwitcher = activeView === 'vyzualz' && !!onAppViewChange
      ...
      <nav className="az-nav">
        {showAppViewSwitcher ? (
          <>
            ...
            >
              {/* Play-screen icon (DRMVYZ brand icon) */}
            ...
            >
              {/* Lyrics icon: document with text lines + music note accent */}
              <svg viewBox="0 0 28 28" width="28" height="28" fill="none">
                ...
                {/* Small music note bottom-right accent */}
          ...
          // Default: single Vyzualz nav icon (non-vyzualz contexts)
          <div
