...
Test state: `npx vitest run src/components/vyzualz/cinema2` = the same 15 failing files / 40 failing tests that pre-date all this work (listed under "What exists today"), 633 passing after #8; `npm run test:assets` 16 passing; lint and typecheck clean for touched files.
